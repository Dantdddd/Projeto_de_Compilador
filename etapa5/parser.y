...
declaracao_variavel_local: TK_VAR TK_ID TK_ATRIB tipo TK_OC_LE literal {
    ...
    store = ILOC_new_operation(STOREAI, $6->temp, "rfp", offset_str, NULL);
...
expressao_nv3: expressao_nv3 '+' expressao_nv2{
    ...
    ILOC_operation_t *op = ILOC_new_operation(ADD, $1->temp, $3->temp, temp, NULL);
    $$->code = ILOC_concat_operations($1->code, $3->code);
    $$->code = ILOC_concat_operations($$->code, op);
...
expressao_nv3: expressao_nv3 '-' expressao_nv2{
    ...
    ILOC_operation_t *op = ILOC_new_operation(SUB, $1->temp, $3->temp, temp, NULL);
    $$->code = ILOC_concat_operations($1->code, $3->code);
    $$->code = ILOC_concat_operations($$->code, op);
...
expressao_nv2: expressao_nv2 '%' expressao_nv1{
    ...
    ILOC_operation_t *op = ILOC_new_operation(DIV, $1->temp, $3->temp, temp, NULL);
    $$->code = ILOC_concat_operations($1->code, $3->code);
    $$->code = ILOC_concat_operations($$->code, op);
...
expressao_nv2: expressao_nv2 '*' expressao_nv1{
    ...
    ILOC_operation_t *op = ILOC_new_operation(MULT, $1->temp, $3->temp, temp, NULL);
    $$->code = ILOC_concat_operations($1->code, $3->code);
    $$->code = ILOC_concat_operations($$->code, op);
